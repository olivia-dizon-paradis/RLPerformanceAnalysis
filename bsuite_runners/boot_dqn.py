...
# ============================================================================
# Code adapted from: https://github.com/deepmind/bsuite/blob/main/bsuite/baselines/tf/boot_dqn/run.py
#                    https://github.com/google-deepmind/bsuite/blob/main/bsuite/baselines/tf/boot_dqn/agent.py
# Changes: using boot_dqn.default_agent
#          added timing and model-saving functionality
#          allows editing of num_processes
#          garbage collection
# ============================================================================
"""Run a bootstrapped DQN agent instance on a bsuite experiment."""
...
def run(bsuite_id: str) -> str:
  """Runs a Boot DQN agent on a given bsuite environment, logging to CSV."""
  ...
  with open(fname, 'wb+') as handle:
      pickle.dump(agent._ensemble, handle)
