...
# ============================================================================
# Code adapted from: https://github.com/deepmind/bsuite/blob/main/bsuite/baselines/tf/actor_critic_rnn/run.py
#                    https://github.com/google-deepmind/bsuite/blob/main/bsuite/baselines/tf/actor_critic_rnn/agent.py
# Changes: using actor_critic_rnn.default_agent
#          added timing and model-saving functionality
#          allows editing of num_processes
#          garbage collection
# ============================================================================
"""Run an actor-critic agent (+RNN) instance on a bsuite experiment."""
...
def run(bsuite_id: str) -> str:
  """Runs an A2C RNN agent on a given bsuite environment, logging to CSV."""
