...
#                    https://github.com/google-deepmind/bsuite/blob/main/bsuite/baselines/tf/dqn/agent.py
# Changes: using dqn.default_agent
...
def run(bsuite_id: str) -> str:
  ...
  with open(fname, 'wb+') as handle:
      pickle.dump(agent._online_network, handle)
