""" Wrapper to use C51 Policy in bsuite experiment.
    Code adapted from: https://github.com/thu-ml/tianshou/blob/master/tianshou/policy/modelfree/c51.py
...
class default_agent(base.Agent):
  def __init__(self, obs_spec, act_spec, buffer_size=128):
    ...
    self.agent = ts.policy.C51Policy(self.net, self.optim, num_atoms=51).to(device)
