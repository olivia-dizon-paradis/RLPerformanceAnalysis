""" Wrapper to use Synchronous Advantage Actor-Critic (A2C) Policy in bsuite experiment.
    Code adapted from: https://github.com/thu-ml/tianshou/blob/master/tianshou/policy/modelfree/a2c.py
...
class default_agent(base.Agent):
  def __init__(self, obs_spec, act_spec, buffer_size=128):
    ...
    self.agent = ts.policy.A2CPolicy(self.actor,
                                     self.critic,
                                     self.optim,
                                     self.dist,
