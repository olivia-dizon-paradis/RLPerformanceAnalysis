""" Wrapper to use Dueling DQN Policy in bsuite experiment.
    Code adapted from: https://github.com/thu-ml/tianshou/blob/master/tianshou/policy/modelfree/dqn.py
    Implementation of Dueling DQN. arXiv:1511.06581
"""
...
class default_agent(base.Agent):
  def __init__(self, obs_spec, act_spec, buffer_size=128):
    ...
    Q_param = {"hidden_sizes": [32]}
    V_param = {"hidden_sizes": [32]}
    self.net = ts.utils.net.common.Net(self.obs_shape, self.act_n, hidden_sizes=[64,64], dueling_param=(Q_param,V_param), device=device)
